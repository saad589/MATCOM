...
contains
    ...
    ! Generates Serpent input file for given temperature and density profile.
    !
    ! Inputs:
    ! -------
    !
 ...
 !
    ...
    ! Read Serpent output file and returns fuel linear power profile  
    !
    ! Inputs:
    ! -------
    !
    ...
    ! -------
    !
    ! linear_pin_power : the fuel power profile corresponding to the nodes
    !
    ! Interface:
    ! ---------
    !
    ...
    subroutine serpent_out_handle(iteration, nodes, linear_pin_power)
        ...
        !
        linear_pin_power = raw(:,11)/0.366 ! divided by nodal width (m)

    end subroutine serpent_out_handle

end module serpent_procedures
